...
export default defineNuxtComponent({
  name: "HouseholdNotificationsTab",
  setup() {
    ...
    const optionsSections: OptionSection[] = [
      ...
      },
      {
        ...
        options: [
          { text: i18n.t("events.when-a-new-user-joins-your-group") as string, key: "userSignup" },
        ],
      },
      {
        id: 3,
        ...
        options: [
          { text: i18n.t("events.when-a-user-in-your-group-creates-a-new-mealplan") as string, key: "mealplanEntryCreated" },
        ],
      },
      {
        id: 4,
